...
import { clearDefinitions, onInlayHints, onCompletion, onDefinition, onDocumentSymbol, onWorkspaceSymbol, readSingleFile, validPerlFile, onSignatureHelp } from './Perl';
